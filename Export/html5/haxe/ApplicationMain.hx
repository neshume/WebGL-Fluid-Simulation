...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("WebGLFluidSimulation", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("WebGLFluidSimulation", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "WebGLFluidSimulation";
		app.meta["name"] = "WebGLFluidSimulation";
		app.meta["packageName"] = "com.sample.webglfluidsimulation";
